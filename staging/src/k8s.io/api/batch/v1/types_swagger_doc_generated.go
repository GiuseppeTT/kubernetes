...
var map_PodFailurePolicyRule = map[string]string{
	...
	"name":            "Specifies the name of the rule. This field provides a way to identify the rule when it is evaluated. When the rule matches a pod failure, the name of the rule is appended to the \"PodFailurePolicy\" condition reason in the format \"PodFailurePolicy_{ruleName}\". If the value is nill, the Job controller will default the condition reason to \"PodFailurePolicy_{ruleIndex}\". This field is used in the alpha-level feature: https://kep.k8s.io/4443.",
